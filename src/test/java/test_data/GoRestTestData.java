...
public class GoRestTestData {
    ...
    public Map<String,String> dataKeyMap(String name,String email,String gender, String status){//ic map
    ...
    public Map<String,Object> expectedDataMethod(Object meta,Map<String ,String> data){//dis map
